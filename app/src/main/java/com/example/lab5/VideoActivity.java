...
public class VideoActivity extends AppCompatActivity {
    ...
    private Button btnPlayPauseVideo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvNowPlaying = findViewById(R.id.tvNowPlaying); // Добавьте TextView в разметку
        tvNowPlaying.setText("Видео: " + getFileName(videoUri));
    }
